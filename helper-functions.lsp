...
(declaim (ftype (function (string &optional (integer *) (integer *)) (or integer list)) first-non-alphanumeric-char))
(declaim (ftype (function (string &optional (integer *) (integer *)) (or integer list)) first-alphanumeric-char))
(declaim (ftype (function (string &optional (integer *) (integer *)) (or integer list)) first-non-zero-in-string))
(declaim (ftype (function (list string &optional (integer 0)) list) or-find))
(declaim (ftype (function (list) array) list-to-array))
...
(declaim (ftype (function (stream character) string) read-single-quote-string))
